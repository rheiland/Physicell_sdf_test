...
# CFLAGS := -mcpu=$(ARCH) -O3 -fomit-frame-pointer -mfpmath=both -fopenmp -m64 -std=c++11
CFLAGS := -march=$(ARCH) -O3 -fomit-frame-pointer -fopenmp -m64 -std=c++11
# CFLAGS := -march=$(ARCH) -O3 -fomit-frame-pointer -fopenmp -m64 -std=c++11 -target x86_64-apple-darwin20.3.0
...
PhysiCell_custom_module_OBJECTS := custom.o mechanics.o
...
mechanics.o: ./custom_modules/mechanics.cpp 
	$(COMPILE_COMMAND) -c ./custom_modules/mechanics.cpp
